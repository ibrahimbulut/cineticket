...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <hr>
      <!-- Preview Image -->
      <img class="img-fluid rounded" src="img/filmler/boru.png" alt="">
      <hr>
      <!-- Post Content -->
