...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <!-- Title -->
      <h1 class="mt-4">Kafalar Karışık</h1>
      ...
      <hr>
      <!-- Preview Image -->
      <img class="img-fluid rounded" src="img/filmler/kafalarkarisik.png" alt="">
      <hr>
      <!-- Post Content -->
