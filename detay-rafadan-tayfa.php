...
<html lang="tr" dir="ltr">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="filmdetay.css" media="screen" />
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-lg-8">
      ...
      <!-- Title -->
      <h1 class="mt-4">Rafadan Tayfa: Dehliz Macerası</h1>
      ...
      <hr>
      <!-- Preview Image -->
      <img class="img-fluid rounded" src="img/filmler/rafadantayfa.png" alt="">
      <hr>
      <!-- Post Content -->
            ...
            <p class="lead"><small><small>Rafadan Tayfa Dehliz Macerası, mahallelerindeki evlerin yıkılmasını önlemek için maceraya atılan Rafadan Tayfa ekibinin hikayesini konu ediyor. Bir inşaat firması, mahalledeki evlerin sağlamlığını kontrol etmek için gelince mahallelide büyük bir panik oluşur. Daha ortada bir sonuç yokken herkes evlerinin yıkılma ihtimalini düşünerek korkuya kapılır. Binaların yıkılacağı üzerine bir de söylenti çıkınca mahalleli iyice ayağa kalkar. Mahalle sakinlerinden bir tek Kuşçu Baba sakindir. O, mahallenin tarihi değerinden dolayı kimsenin mahalleye dokunamayacağını düşünür. Fakat, hafızasına pek de güvenilmeyen Kuşçu Baba’nın söylediklerine kimse güvenmez. Onu tek ciddiye alan ise Rafadan Tayfa ekibidir. Kuşçu Baba’nın söylediklerini araştırmaya karar verip kütüphaneye gidince anlatılanların doğru olduğunu öğrenir. Yaşadıkları mahallenin altından İstanbul’un en eski dehlizlerinden bir tanesi geçmektedir. Artık onların tek bir amacı vardır; dehlizi bulup mahalleyi yıkımdan kurtarmak.
            </small></small></p>
